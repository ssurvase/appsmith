...
import static com.external.plugins.utils.OracleDataTypeUtils.DataType.INT;
...
import static com.external.plugins.utils.OracleDataTypeUtils.DataType.TEXT;
...
public class OracleDataTypeUtils {
    ...
    public static class DataType {
        /**
         * Declare all the explicitly castable Oracleql types below. These would be automatically added to the
